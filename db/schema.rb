...
ActiveRecord::Schema[8.1].define(version: 2025_12_10_174017) do
  ...
  create_table "onboardings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.boolean "dates_visible", default: true
    t.text "description"
    t.datetime "due_date"
    t.boolean "emails_visible", default: true
    t.datetime "end_date"
    t.string "hubspot_id"
    t.datetime "hubspot_synced_at"
    t.boolean "info_visible", default: true
    t.integer "meetings_limit"
    t.boolean "meetings_visible", default: true
    t.boolean "notes_visible", default: true
    t.boolean "participants_visible", default: true
    t.boolean "progress_visible", default: true
